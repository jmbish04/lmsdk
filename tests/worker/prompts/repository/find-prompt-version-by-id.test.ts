...
describe("PromptRepository - findPromptVersionById", () => {
  ...
  it("should find prompt version by id", async () => {
    ...
    const found = await repository.findPromptVersionById(createProjectId(1, 1), version.id);
  ...
  it("should return undefined when tenant does not match", async () => {
    ...
    const found = await repository.findPromptVersionById(createProjectId(1, 2), version.id);
