...
describe("TraceService - listProjectTraces", () => {
  ...
  describe("Cross-tenant Protection", () => {
    ...
    it("returns empty array when requesting different tenant's project", async () => {
      ...
      const result = await traceService.listProjectTraces({ projectId: createProjectId(42, 2),
        page: 1,
        pageSize: 10,
      });
    ...
    it("maintains tenant isolation across multiple tenants and projects", async () => {
      ...
      const t1p10 = await traceService.listProjectTraces({ projectId: createProjectId(10, 1),
        page: 1,
        pageSize: 10,
      });
      ...
      const t1p20 = await traceService.listProjectTraces({ projectId: createProjectId(20, 1),
        page: 1,
        pageSize: 10,
      });
      ...
      const t2p20 = await traceService.listProjectTraces({ projectId: createProjectId(20, 2),
        page: 1,
        pageSize: 10,
      });
      ...
      const t3p10 = await traceService.listProjectTraces({ projectId: createProjectId(10, 3),
        page: 1,
        pageSize: 10,
      });
    ...
    it("pagination respects tenant boundaries", async () => {
      ...
      const page1 = await traceService.listProjectTraces({ projectId: createProjectId(42, 1),
        page: 1,
        pageSize: 10,
      });
      ...
      const page2 = await traceService.listProjectTraces({ projectId: createProjectId(42, 1),
        page: 2,
        pageSize: 10,
      });
