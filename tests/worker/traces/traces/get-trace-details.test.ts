...
import { TraceService } from "../../../../worker/traces/traces.service";
...
describe("TraceService - getTraceDetails", () => {
  ...
  beforeEach(async () => {
    ...
    db = drizzle(env.DB);
    traceService = new TraceService(env.DB);
  });

  const createProjectId = (projectId: number, tenantId: number): ProjectId => {
    return new ProjectId(projectId, tenantId, "test-user-id");
  };

  const createTraceId = (traceId: string, projectId: number, tenantId: number): EntityId<string> => {
    return new EntityId<string>(traceId, createProjectId(projectId, tenantId));
  };
  ...
  describe("Basic Functionality", () => {
    it("returns null when trace does not exist", async () => {
      const result = await traceService.getTraceDetails(createTraceId("non-existent", 42, 1));
    ...
    it("returns trace with empty logs array when trace has no logs", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("trace-abc", 42, 1));
  ...
  describe("Cross-tenant Protection", () => {
    it("returns null when trace exists but belongs to different tenant", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("trace-abc", 42, 2));
    ...
    it("returns null when trace exists for different project", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("trace-abc", 99, 1));
    ...
    it("only returns logs belonging to the same tenant", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("shared-trace", 42, 1));
    ...
    it("enforces strict tenant isolation across multiple scenarios", async () => {
      ...
      expect((await traceService.getTraceDetails(createTraceId("t2-trace", 10, 1))).trace).toBeNull();
      expect((await traceService.getTraceDetails(createTraceId("t1-trace", 10, 2))).trace).toBeNull();
      expect((await traceService.getTraceDetails(createTraceId("t3-trace", 10, 1))).trace).toBeNull();
    });
    ...
    it("validates both tenant and project match", async () => {
      ...
      const t1p10 = await traceService.getTraceDetails(createTraceId("duplicate-id", 10, 1));
      ...
      const t1p20 = await traceService.getTraceDetails(createTraceId("duplicate-id", 20, 1));
      ...
      const t2p10 = await traceService.getTraceDetails(createTraceId("duplicate-id", 10, 2));
      ...
      expect((await traceService.getTraceDetails(createTraceId("duplicate-id", 20, 2))).trace).toBeNull();
    });
  });
  ...
  describe("Edge Cases", () => {
    it("handles trace with many logs efficiently", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("large-trace", 42, 1));
    ...
    it("handles logs with null/undefined fields", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("trace-with-nulls", 42, 1));
    ...
    it("handles special characters in traceId", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId(specialTraceId, 42, 1));
    ...
    it("handles logs from different prompts within same trace", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("multi-prompt-trace", 42, 1));
    ...
    it("returns logs with success and error mixed", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("mixed-trace", 42, 1));
    ...
    it("handles empty string traceId gracefully", async () => {
      const result = await traceService.getTraceDetails(createTraceId("", 42, 1));
  ...
  describe("Prompt Information", () => {
    it("includes prompt name and slug when prompt exists", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("test-trace", 42, 1));
    ...
    it("returns null for prompt name/slug when prompt does not exist", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("orphaned-log-trace", 42, 1));
    ...
    it("correctly joins prompts across multiple logs", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("multi-log-trace", 42, 1));
    ...
    it("only joins prompts from the same tenant", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("tenant-isolation-trace", 42, 1));
    ...
    it("handles mixed scenario with some prompts existing and some not", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("mixed-prompts-trace", 42, 1));
  ...
  describe("Span Extraction", () => {
    it("parses rawTraceId and returns span data", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("trace-123", 42, 1));
  ...
  describe("Data Integrity", () => {
    it("returns complete trace metadata", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("metadata-trace", 42, 1));
    ...
    it("preserves log ordering in chronological order", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("ordered-trace", 42, 1));
