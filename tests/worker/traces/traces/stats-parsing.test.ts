...
describe("TraceService - Stats Parsing", () => {
  ...
  describe("Stats JSON Parsing", () => {
    it("parses stats JSON string into object for OpenAI provider", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("trace-openai", 42, 1));
    ...
    it("parses stats JSON string into object for Google provider", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("trace-google", 42, 1));
    ...
    it("parses stats with multiple providers and models", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("trace-multi", 42, 1));
    ...
    it("returns null for stats when stats field is null", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("trace-no-stats", 42, 1));
    ...
    it("returns null for stats when stats is empty string", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("trace-empty-stats", 42, 1));
    ...
    it("handles invalid JSON gracefully", async () => {
      ...
      await expect(async () => {
        await traceService.getTraceDetails(createTraceId("trace-invalid-json", 42, 1));
      }).rejects.toThrow();
    });
    ...
    it("preserves all token fields including zeros", async () => {
      ...
      const result = await traceService.getTraceDetails(createTraceId("trace-with-zeros", 42, 1));
  ...
  describe("List Traces Stats Parsing", () => {
    it("parses stats for multiple traces in list", async () => {
      ...
      const result = await traceService.listProjectTraces({ projectId: createProjectId(42, 1),
        page: 1,
        pageSize: 10,
      });
  ...
  describe("Cross-tenant Protection with Stats", () => {
    it("only returns stats for traces belonging to tenant", async () => {
      ...
      const result1 = await traceService.getTraceDetails(createTraceId("trace-t1", 42, 1));
      ...
      const result2 = await traceService.getTraceDetails(createTraceId("trace-t2", 42, 2));
      ...
      const crossAccess = await traceService.getTraceDetails(createTraceId("trace-t2", 42, 1));
